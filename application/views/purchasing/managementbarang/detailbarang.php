...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url('purchasing/managementbarang'); ?>">Management Barang</a></li>
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="card-footer text-md-right">
                <a href="<?= base_url('purchasing/managementbarang'); ?>" class="btn btn-secondary">Kembali</a>
            </div>
        </form>
    </div>
</div>